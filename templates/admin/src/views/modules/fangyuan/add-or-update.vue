		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="总价格" prop="zongjiage">
					<el-input v-model="ruleForm.zongjiage" placeholder="总价格" clearable  :readonly="ro.zongjiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="总价格" prop="zongjiage">
					<el-input v-model="ruleForm.zongjiage" placeholder="总价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="平均价格" prop="pingjunjiage">
					<el-input v-model="ruleForm.pingjunjiage" placeholder="平均价格" clearable  :readonly="ro.pingjunjiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="平均价格" prop="pingjunjiage">
					<el-input v-model="ruleForm.pingjunjiage" placeholder="平均价格" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="装修" prop="zhuangxiu">
					<el-input v-model="ruleForm.zhuangxiu" placeholder="装修" clearable  :readonly="ro.zhuangxiu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="装修" prop="zhuangxiu">
					<el-input v-model="ruleForm.zhuangxiu" placeholder="装修" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.laiyuan" label="来源" prop="laiyuan">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.laiyuan}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='pingjunjiage'){
							this.ruleForm.pingjunjiage = obj[o];
							this.ro.pingjunjiage = true;
							continue;
						}
						if(o=='huxing'){

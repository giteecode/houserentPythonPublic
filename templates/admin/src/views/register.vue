<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"linear-gradient(-151deg, #EFE2D2 0%, #FFF3E8 100%)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"0 0 20px","margin":"0","borderColor":"#fdf7f1","borderRadius":"0px","background":"#fff","borderWidth":"10px 10px","width":"500px","borderStyle":"solid","height":"auto","opacity":".95"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"10px","margin":"0 0 20px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","height":"auto"}' class="title">租房推荐系统注册</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='fangdong'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">房东账号</div>
					<el-input  v-model="ruleForm.fangdongzhanghao"  autocomplete="off" placeholder="房东账号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='fangdong'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">房东姓名</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='fangdong'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">房东手机</div>
					<el-input  v-model="ruleForm.fangdongshouji"  autocomplete="off" placeholder="房东手机"  type="text"  />
				</el-form-item>
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"20px auto 10px","outline":"none","color":"#fff","borderRadius":"8px","background":"#000","display":"block","width":"80%","fontSize":"22px","height":"54px"}' type="button" class="r-btn" @click="login()">注册</button>
	...
	methods: {
		...
		login() {
			var url=this.tableName+"/register";
					...
					if(`fangdong` == this.tableName && this.ruleForm.shenfenzhenghao&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzhenghao))){
					...
					if(`fangdong` == this.tableName && this.ruleForm.fangdongshouji&&(!this.$validate.isMobile(this.ruleForm.fangdongshouji))){

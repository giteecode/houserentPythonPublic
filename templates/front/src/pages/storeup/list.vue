...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"28px","background":"#CD9571","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="warning" size="mini" @click="backClick" class="el-icon-back">返回</el-button>
    <div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 0 5%","margin":"10px 0","color":"#333","textAlign":"left","background":"url(http://codegen.caihongy.cn/20220915/d11872980daa4bf28febfc2062bf4a46.png) center center/cover no-repeat","fontSize":"20px","lineHeight":"54px"}'>我的收藏</div>

		...
		<div class="attr" :style='{"padding":"20px","position":"relative","background":"#fff","flexDirection":"row-reverse","display":"flex"}'>
			...
			<div class="info" :style='{"width":"640px","padding":"10px","margin":"0 10px 0 0","background":"#f5f5f5"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"transparent","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"100px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>用户名</div>
					<div  :style='{"border":"3px solid #CD9571","padding":"0 10px","color":"#666","width":"calc(100% - 100px)","fontSize":"14px","lineHeight":"40px","height":"auto"}'>{{detail.username}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"transparent","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"100px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>角色</div>
					<div  :style='{"border":"3px solid #CD9571","padding":"0 10px","color":"#666","width":"calc(100% - 100px)","fontSize":"14px","lineHeight":"40px","height":"auto"}'>{{detail.role}}</div>
				</div>

		...
		<div class="attr" :style='{"padding":"20px","position":"relative","background":"#fff","flexDirection":"row-reverse","display":"flex"}'>
			...
			<div class="info" :style='{"width":"640px","padding":"10px","margin":"0 10px 0 0","background":"#f5f5f5"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"transparent","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"100px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>预约编号</div>
					<div  :style='{"border":"3px solid #CD9571","padding":"0 10px","color":"#666","width":"calc(100% - 100px)","fontSize":"14px","lineHeight":"40px","height":"auto"}'>{{detail.yuyuebianhao}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"transparent","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"transparent","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"100px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>预约时间</div>
					<div  :style='{"border":"3px solid #CD9571","padding":"0 10px","color":"#666","width":"calc(100% - 100px)","fontSize":"14px","lineHeight":"40px","height":"auto"}'>{{detail.yuyueshijian}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"28px","background":"#CD9571","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('zufangyuyue','合同')" @click="onAcross('zufanghetong','是','','')" type="warning">合同</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"28px","background":"#A26842","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('zufangyuyue','审核')" @click="onSH" type="warning">审核</el-button>
				</div>
			</div>
  ...
  export default {
    ...
    methods: {
      ...
      onAcross(acrossTable,crossOptAudit,statusColumnName,tips,statusColumnValue){
        localStorage.setItem('crossTable',`zufangyuyue`);
